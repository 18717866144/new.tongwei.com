...
<div class="wrap snav">
	...
	<a href="/paper/{-$paper.id-}.html" class="" style="text-align: center;">{-$paper.title-}</a>
	</ul>	
</div>
...
<div class="paperlist" style="margin:10px 10px 0px;">
	...
	<span id="paperLayoutTitle">{-$layout.layout_number-}：{-$layout.layout_title-} <i class="iconfont icon-down"></i>
		<div id="paperLayout" style="display: none;z-index: 90;">
			<ul>
...
<div class="wrap clearfix" id="minHeight">
    <div class="swiper-container" id="swiper-container4">
		<ul class="news-list swiper-wrapper">
			...
			<li class="swiper-slide" style="height: 25px!important;">
			<a href="{-$values['areaLink']-}" class="headlines-pic">
                ...
                <img src="{-$layout.thumbnail-}" alt="" height="300px">
            </a>
			</li>
			</volist>
		</ul>
