...
<link media="all" rel="stylesheet" href="{-$Think.config.INSTALL_PATH-}/static/css/style.css?20180226">
...
<div id="header" class="row">
	<div class="header wrap clearfix">
		<div class="logo left"><a href="{-$Think.config.INSTALL_PATH-}/" title="{-$Think.config.web_name-}" target="_blank"><img src="{-$Think.config.INSTALL_PATH-}/static/images/logo.jpg"></a></div>
