...
<extend name="./Core/Template/Default/Pc/base_new.php" />
<block name="banner">
...
<div class="wrap m-t-10 clearfix">
	<div class="left index-left">
		...
		<div class="title-1" style="margin-top:16px;">
	...
	<div class="right index-right" style="margin-right:10px;">		
	...
	$.G.playVideo(video);
					...
					<div class="index-special m-t-10">
						<ul>
							...
							<li class="li-1">
								<a href="/news/9305.html" class="thumb" target="_blank"><img src="/static/img/s/s14.png"></a>
								<div class="right-content">
									<a href="/news/9305.html" class="tit" target="_blank">2018集团“身边的榜样”颁奖盛典隆重举行</a>
									<p>12月13日，以“传承通威文化 弘扬榜样力量”为主题的2018通威集团“身边的榜样”匠心工程暨颁奖盛典在通威国际中心隆重举行。来自集团、股份管理总部、通威太阳能（成都）有限公司及各兄弟公司300余位领导、员工参加。</p>
								</div>
							</li>
						</ul>
					</div>		
