            ...
            <div class="zt-two-wrap">
                <div class="whitebox">
                    <div class="zttwo-title bg2 mb20 topage1">
                        ...
                        <p class="t2">图文报道</p>
                        <a class="more" href="{-:U('modules/special/lists?specialid='.$specialid.'&typeid=1')-}">更多</a>
                    </div>
                    <div class="top-report">
                        <div class="headlines">
                            ...
                            <a href="{-$values['url']-}" target="_blank">
                                ...
                                <div class="desc">
                                    {-:msubstr($values['description'],0,70)-}
                                </div>
                            </a>
                            </sql>
                        </div>
                        <div class="head-hot-wrap">
                            <div class="left">
                                        ...
                                        <li class="swiper-slide">
                                            <a href="javascript:;">
                                                <div class="pic">
                                                    ...
                                                    <img class="img" src="{-$values['thumbnail']-}" alt="">
                                                </div>
                                                <div class="tt"></div>
                                            </a>
                                        </li>
                                ...
                                <div class="zttwo-video topage3">
                                    <div class="zttwo-title mb20">
                                        ...
                                        <p class="t2">视频报道</p>
                                        <a class="more" href="{-:U('modules/special/lists?specialid='.$specialid.'&typeid=5')-}">更多</a>
                                    </div>
                                    <ul class="swiper-wrapper">
                                        <sql sql="select * from h_special_content where a_status=1 and typeid=5 and specialid={$specialid} order by sort desc,id desc limit 9">
                                        <li class="swiper-slide" data-src="{-$values['url']-}">
                                            <a href="javascript:;">
                                                <div class="pic">
                                                    <div class="bgimg" style="background-image: url({-$values['thumbnail']-});">
                                                    </div>
                            ...
                            <div class="right">
                                <ul class="zttwo-newslist">
                                    <sql sql="select * from h_special_content where a_status=1 and typeid=1 and specialid={$specialid} order by sort desc,id desc limit 11">
                    ...
                    <div class="zt-two-bottom">
                        <div class="left">
                            <div class="zttwo-title mb20 topage2">
                                <p class="t1">刘汉元代表十四届全国人大一次会议</p>
                                <p class="t2">代表议案</p>
                                <a class="more" href="{-:U('modules/special/lists?specialid='.$specialid.'&typeid=2')-}">更多</a>
                            </div>
                            <ul class="two-tiyi">
                                ...
                                <li>
                                    <a href="{-$values['url']-}" target="_blank">
                                        ...
                                        <div class="con">
                                            <p class="tt">{-:($values['title_short']?$values['title_short']:$values['title'])-}</p>
                                            <div class="desc">
                                                {-:msubstr($values['description'],0,160)-}
                                            </div>
                                        </div>
                                    </a>
                                </li>
                        ...
                        <div class="right">
                            <div class="zttwo-title mb20 topage5">
                                <p class="t1">刘汉元代表十四届全国人大一次会议</p>
                                <p class="t2">往期回顾</p>
                                <a class="more" href="{-:U('modules/special/lists?specialid='.$specialid.'&typeid=6')-}">更多</a>
                            </div>
                            <ul class="zttwo-newslist nt mb20">
                                <sql sql="select * from h_special_content where a_status=1 and typeid=6 and specialid={$specialid} order by sort desc,id desc limit 4">
                                <li>
                                    <a href="{-$values['url']-}" target="_blank">
                                        <p class="tt">{-$values.title-}</p>
                                    </a>
                            ...
                            <div class="zttwo-title mb20 topage4">
                                <p class="t1">刘汉元代表十四届全国人大一次会议</p>
                                <p class="t2">媒体聚焦</p>
                                <a class="more" href="{-:U('modules/special/lists?specialid='.$specialid.'&typeid=3')-}">更多</a>
                            </div>
                            <div class="zttwo-media">
                                <ul class="swiper-wrapper">
                                    <sql sql="select * from h_special_content where FIND_IN_SET('h',attr) and a_status=1 and typeid=3 and specialid={$specialid} order by sort desc,id desc limit 3">
                                    <li class="swiper-slide">
                                        <a href="{-$values['url']-}" target="_blank">
                                            <div class="pic"><img src="{-$values['thumbnail']|thumb=###,580,326,1-}" alt=""></div>
                                            <p class="tt">{-$values.title-}</p>
                                        </a>
                                    </li>
                                    </sql>
                            ...
                            <ul class="zttwo-newslist nt">
                                <sql sql="select * from h_special_content where FIND_IN_SET('j',attr) and a_status=1 and typeid=3 and specialid={$specialid} order by sort desc,id desc limit 4">
                                <li>
                                    <a href="{-$values['url']-}" target="_blank">
                                        <p class="tt">{-$values.title-}</p>
                                    </a>
