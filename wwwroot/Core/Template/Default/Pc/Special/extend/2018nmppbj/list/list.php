...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link href="/static/2018nmppbj/css1.css" rel="stylesheet">
	<link href="/static/2018nmppbj/fitCss1.css" rel="stylesheet">
	<!--[if lt IE 9]>
...
<div id="nav-menu" class="fit-menu" >
		...
		<ul class="ul-fmw clearfix" id="home">
			<li >
			<a href="/special/14.html">返回专题</a>
			</li>
			<li class="active">
			
			<a class="fmwList n-twbd" href="javascript:;">图文报道</a>
			</li>
	...
	<div class="row news clearfix" style="min-height:600px;">
				<div class="col-md-5 nw-r nw-l" style="width:100%;">
					<ul class="nw-r-ul">
                        ...
                        <sql sql="select * from h_special_content where (specialid=14 and cid=15) or (specialid=14 and  is_link=1 ) order by save_time desc">
							<li class="nw-li-a">
