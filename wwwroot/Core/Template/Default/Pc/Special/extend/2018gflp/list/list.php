...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link href="/static/2018gflp/css1.css" rel="stylesheet">
	<link href="/static/2018gflp/fitCss1.css" rel="stylesheet">
	<!--[if lt IE 9]>
	...
	<div class="row news clearfix" style="min-height:600px;">
				<div class="col-md-5 nw-r nw-l" style="width:100%;">
					<ul class="nw-r-ul">
                        ...
                        <sql sql="select * from h_special_content where (specialid=13 and cid=15) or (specialid=13 and  is_link=1 ) order by save_time desc">
							<li class="nw-li-a">
