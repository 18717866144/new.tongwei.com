...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<title>2020第四届中国水产科技大会</title>
	<meta name="keywords" content="2020第四届中国水产科技大会">
	<meta name="description" content="2020第四届中国水产科技大会">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no"/>
	<link href="/static/2020shuichan/bootstrap.min.css" rel="stylesheet">
	<link href="/static/2020shuichan/css.css" rel="stylesheet">
	<link href="/static/2020shuichan/fitCss.css" rel="stylesheet">
	<link href="/static/2020shuichan/superslide.css" rel="stylesheet">
...
#video  .videos .video{    
      ...
      #video .videos .video li img {
       ...
       #video .videos .video ul li:hover .play{    
            background:url('/static/2020shuichan/play_on.png') center no-repeat;
          background-size: 50px;
        }
...
<div >
	<div id="top_banner">
		<img src="/static/2020shuichan/2020_sckj_bg.jpg" alt="" style="width:100%;">
	</div>
</div>
	...
	<div class="twbdWrap">
		<div class="conWp">
			...
			<div id="slideBox" class="slideBox">
				...
				<sql sql="select title from h_special_content where specialid=22 and typeid=3 and a_status=1 order by sort desc">
				...
				<sql sql="select title,thumbnail from h_special_content where specialid=22 and typeid=3 and a_status=1 order by sort desc">
				<li>
		...
		<script type="text/javascript">
			...
			<div class="row news clearfix" style="min-height:200px;">
				...
				<div class="col-md-5 nw-r" style="min-height:217px;">
					<ul class="nw-r-ul">
                        <sql sql="select * from h_special_content where specialid=22 and typeid=5 and a_status=1 and attr='' order by sort desc limit 5">
							<li class="nw-li-a">
			...
			<div class="newsMore">
				<a href="http://www.tongwei.com/special/lists/specialid/22/typeid/1.html">查看更多</a> 
			</div>
...
<div class="ltjj" id="ltjj">
	...
	<div class="ltjjWrap">
	<sql sql="select content from h_special_content where (specialid=22 and typeid=1)  limit 1">
	{-$values['content']-}
	</sql>
	</div>
</div>
...
<div class="nyjb" id="nyjb">
	...
	<sql sql="select title,description,thumbnail from h_special_content where (specialid=22 and typeid=6)  order by sort desc,save_time asc limit 50">
	    <li>
		  <a href="javascript:;">
...
<div class="nyqy" id="qczcdw">
	...
	<div class="nyqyWrap" style="margin-bottom:0px;">
        ...
        <sql sql="select title,thumbnail from h_special_content where (specialid=22 and typeid=9)  order by sort desc,save_time asc limit 50">
...
<div class="nyqy" id="xbdw">
	...
	<div class="nyqyWrap" style="margin-bottom:0px;">
        ...
        <sql sql="select title,thumbnail from h_special_content where (specialid=22 and typeid=7)  order by sort desc,save_time asc limit 50">
...
<div class="nyqy" id="tbzzdw">
	...
	<div class="nyqyWrap" style="margin-bottom:0px;">
        ...
        <sql sql="select title,thumbnail from h_special_content where (specialid=22 and typeid=11)  order by sort desc,save_time asc limit 50">
			<li><a href="javascript:;">
					<div class="qyImg"><img data-funlazy="{-$values['thumbnail']-}"></div>
					<div class="qyTxt">{-$values['title']-}</div>
				</a>
...
<div class="nyqy" id="zcdw">
	...
	<div class="nyqyWrap" style="margin-bottom:0px;">
        ...
        <sql sql="select title,thumbnail from h_special_content where (specialid=22 and typeid=12)  order by sort desc,save_time asc limit 50">
			<li><a href="javascript:;">
					<div class="qyImg"><img data-funlazy="{-$values['thumbnail']-}"></div>
					<div class="qyTxt">{-$values['title']-}</div>
				</a>
...
<div class="hzmt" id="hzmt">
	...
	<ul class="mt-ul clearfix">
	    ...
	    <sql sql="select title,thumbnail from h_special_content where (specialid=22 and typeid=8)  order by sort desc,save_time asc limit 50">
			<li>
...
<div class="lxwm" id="contact">
	...
	<div class="lxWrap clearfix" >
		...
		<div style="height:40px;text-align:center;font-size:14px;">商务合作：陈先生18782983897&nbsp;&nbsp;&nbsp;&nbsp;康先生18628275781&nbsp;&nbsp;&nbsp;&nbsp;张女士18384248524</div> 	
