	...
	<div class="twbdWrap">
		<div class="conWp">
			...
			<div id="slideBox" class="slideBox">
				...
				<sql sql="select title from h_special_content where specialid=30 and typeid=1 and a_status=1 order by sort desc">
				...
				<sql sql="select title,thumbnail from h_special_content where specialid=30 and typeid=1 and a_status=1 order by sort desc">
				<li>
			...
			<div class="row news clearfix" style="min-height:200px;">
				...
				<div class="col-md-5 nw-r" style="min-height:217px;">
					<ul class="nw-r-ul">
                        <sql sql="select * from h_special_content where specialid=30 and typeid=2 and a_status=1 and attr='' order by sort desc limit 5">
							<li class="nw-li-a">
...
<div class="ltjj" id="ltjs">
	...
	<div class="ltjjWrap">
	<sql sql="select content from h_special_content where (specialid=30 and typeid=3)  limit 1">
	{-$values['content']-}
	</sql>
	</div>
</div>
...
<div class="nyjb" id="nyjb">
	...
	<sql sql="select title,description,thumbnail from h_special_content where (specialid=30 and typeid=4)  order by sort desc,save_time asc limit 50">
	    <li>
		  <a href="javascript:;">
...
<div class="nyqy" id="lhzb">
	...
	<div class="nyqyWrap" style="margin-bottom:0px;">
        ...
        <sql sql="select title,thumbnail from h_special_content where (specialid=30 and typeid=5)  order by sort desc,save_time asc limit 50">
...
<div class="nyqy" id="xbdw">
	...
	<div class="nyqyWrap" style="margin-bottom:0px;">
        ...
        <sql sql="select title,thumbnail from h_special_content where (specialid=30 and typeid=6)  order by sort desc,save_time asc limit 50">
			<li style="width:180px;display:inline-block;">
...
<div class="nyqy" id="zcdw">
	...
	<div class="nyqyWrap" style="margin-bottom:0px;">
        ...
        <sql sql="select title,thumbnail from h_special_content where (specialid=30 and typeid=7)  order by sort desc,save_time asc limit 50">
			<li style="width:180px;display:inline-block;">
...
<div class="hzmt" id="hzmt" >
	...
	<ul class="mt-ul clearfix">
	    ...
	    <sql sql="select title,thumbnail from h_special_content where (specialid=30 and typeid=8)  order by sort desc,save_time asc limit 50">
			<li>
