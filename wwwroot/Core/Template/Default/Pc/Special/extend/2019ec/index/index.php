...
<div class="wrap clearfix">
    <div class="hdjj">
        ...
        <div class="zw_hdjj">根据通威发〔2019〕4号文件《通威集团2019年企业文化建设工作实施方案》的通知精神，为进一步激发和坚定全体员工与企业共进步、同发展的信心和热情，展现通威人风采，推动文化落地，集团现正式启动2019年度“通威大变革、大跨越”征文活动，全体通威员工均可积极投稿参与。4-11月集团总共进行4期征文评选，每期评选出8篇优秀文章，纳入年度总评选范围，最终评出20篇优秀文章，并在年度企业文化收官活动上对获奖者给予表彰。同时，评选出的优秀征文，将在集团官网、《通威报》等开设专栏进行展示，并整理、编撰后，收录进2019年度通威集团企业文化征文汇编中。</div>
    </div>
    <div class="time"></div>
</div>
...
<div class="show clearfix" id="4th">
    ...
    <div class="show_li">
        ...
        <ul>
			...
			<sql sql="select * from h_special_content where a_status=1 and typeid=4 and specialid={$specialid} order by sort desc,id desc limit 10">
			<li class="news-block">
			
			  <div class="date-block">
				<span class="day">{-$values['author']-}</span><span class="month">{-$values['source']-}</span>			
        	  </div>
			  <div class="summary">            
	        	<div class="h1"><a href="/special/show/specialid/{-$specialid-}/id/{-$values['id']-}.html" target="_blank">{-$values['title']-}</a></div>            
	        	<div class="h3">{-$values['description']-}</div>   
				<a href="/special/show/specialid/{-$specialid-}/id/{-$values['id']-}.html" class="news-detail"></a>
	          </div>			
			</li> 
			 </sql>	 
...
<div class="show clearfix" id="3rd">
    ...
    <div class="show_li">
        ...
        <ul>
			...
			<sql sql="select * from h_special_content where a_status=1 and typeid=3 and specialid={$specialid} order by sort desc,id desc limit 10">
			<li class="news-block">
