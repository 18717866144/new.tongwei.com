...
<div class="wp-mainWrap">
    <div class="uPos">您当前的位置：<a href="javascript:;"
                                target="_blank">首页</a>&nbsp;&gt;&nbsp;<?php if ($_GET['typeid'] == '2') {
            echo '回眸瞬间';
        } elseif ($_GET['typeid'] == '5') {
            echo '精彩活动';
        } elseif ($_GET['typeid'] == '6') {
            echo '媒体寄语';
        }; ?></div>
    <div class="newsList clearfix">
        <div class="news-l">
            <div class="news-l-tit">
                <h3><?php if ($_GET['typeid'] == '2') {
                        echo '回眸瞬间';
                    } elseif ($_GET['typeid'] == '5') {
                        echo '精彩活动';
                    } elseif ($_GET['typeid'] == '6') {
        ...
        <div class="news-r">
            <ul class="news-r-ul">
                <php>$typeid=$_GET['typeid']</php>
                <sql sql="select * from h_special_content where (specialid=37 and typeid={$typeid}) order by sort desc,save_time desc">
                <li onmouseout="this.style.background='#fff';" onmousemove="this.style.background='#f4f9fd';"><a
                            target="_blank"
                            href="{-$values['url']-}">
                        <div class="news-dl">
                            ...
                            <div class="news-dl-txt">
                                ...
                                <p>{-$values['title_short']-} {-$values['keywords']-} {-:($values['description'])-}</p>
                            </div>
                        </div>
                    </a>
                </li>
