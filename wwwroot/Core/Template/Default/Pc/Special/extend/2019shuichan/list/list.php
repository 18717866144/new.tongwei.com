...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link href="/static/2019shuichan/css1.css" rel="stylesheet">
	<link href="/static/2019shuichan/fitCss1.css" rel="stylesheet">
	<!--[if lt IE 9]>
	...
	<div class="row news clearfix" style="min-height:600px;">
				<div class="col-md-5 nw-r nw-l" style="width:100%;">
					<ul class="nw-r-ul">
                        ...
                        <sql sql="select * from h_special_content where (specialid=16 and typeid=5) order by sort desc,save_time desc">
							<li class="nw-li-a">
						...
						<sql sql="select * from h_special_content where (specialid=16 and typeid=4) order by sort desc,save_time desc">
							<li class="nw-li-a">
							<a href="{-$values['url']-}" target="_blank">
								{-:($values['title'])-}
							</a>
