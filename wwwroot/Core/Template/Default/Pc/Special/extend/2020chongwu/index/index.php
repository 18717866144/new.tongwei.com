...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<title>2020第二届中国宠物行业高质量发展论坛</title>
	<meta name="keywords" content="2020第二届中国宠物行业高质量发展论坛">
	<meta name="description" content="2020第二届中国宠物行业高质量发展论坛">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no"/>
	<link href="/static/2020chongwu/bootstrap.min.css" rel="stylesheet">
	<link href="/static/2020chongwu/css.css" rel="stylesheet">
	<link href="/static/2020chongwu/fitCss.css" rel="stylesheet">
	<link href="/static/2020chongwu/superslide.css" rel="stylesheet">
	<link rel="stylesheet" href="/static/2020chongwu/layer.css" id="layui_layer_skinlayercss">
	<!--[if lt IE 9]>
	<script src="//cdn.bootcss.com/html5shiv/3.7.2/html5shiv.min.js"></script>
	<script src="//cdn.bootcss.com/respond.js/1.4.2/respond.min.js"></script>
	<![endif]-->
	<script src="/static/2020chongwu/jquery.min.js"></script>
	<script src="/static/2019nongmu/SuperSlide.2.1.3.js"></script>
	<script src="/static/2020chongwu/layer.min.js"></script>
...
#video  .videos .video{    
      ...
      #video .videos .video li img {
       ...
       #video .videos .video ul li:hover .play{    
            background:url('/static/2020chongwu/play_on.png') center no-repeat;
          background-size: 50px;
        }
...
<div >
	<div id="top_banner">
		<img src="/static/2020chongwu/1920_580.jpg" alt="" style="width:100%;">
	</div>
</div>
...
<div id="nav-menu" class="fit-menu">
		...
		<ul class="ul-fmw clearfix" id="home">
			...
			<li><a class="fmwList n-nyqy" href="#chqy">参会企业</a></li>				
		</ul>
	</div>
</div>
	...
	<div class="twbdWrap">
		<div class="conWp">
			...
			<div id="slideBox" class="slideBox">
				...
				<sql sql="select title from h_special_content where specialid=29 and typeid=1 and a_status=1 order by sort desc">
				...
				<sql sql="select title,thumbnail from h_special_content where specialid=29 and typeid=1 and a_status=1 order by sort desc">
				<li>
			...
			<div class="row news clearfix" style="min-height:200px;">
				...
				<div class="col-md-5 nw-r" style="min-height:217px;">
					<ul class="nw-r-ul">
                        <sql sql="select * from h_special_content where specialid=29 and typeid=2 and a_status=1 and attr='' order by sort desc limit 5">
							<li class="nw-li-a">
			...
			<div class="newsMore">
				<a href="http://www.tongwei.com/special/lists/specialid/29/typeid/1.html">查看更多</a> 
			</div>
...
<div class="ltjj" id="ltjs">
	...
	<div class="ltjjWrap">
	<sql sql="select content from h_special_content where (specialid=29 and typeid=3)  limit 1">
	{-$values['content']-}
	</sql>
	</div>
</div>
...
<div class="nyjb" id="nyjb">
	...
	<img src="/static/2020chongwu/guest1.png" style="width:100%;">
	<img src="/static/2020chongwu/guest2.png" style="width:100%;">
	<!--
	<sql sql="select title,description,thumbnail from h_special_content where (specialid=29 and typeid=4)  order by sort desc,save_time asc limit 50">
	    <li>
		  <a href="javascript:;">
	    ...
	    <div class="bd">
		  <ul>	    		
			...
			<li >
				...
				<p><img src="/static/2020chongwu/chongwu1.jpg"></p>
				<div class="info">
					<i>1</i>
					<div class="t">首届</div>
...
<div class="nyqy" id="chqy">
	<div class="default-comTit" style="margin-top:0px;">
		<div class="def-ct-wrap pAnbg">
			<h3>部分参会<span>单位</span></h3>
			<p>Supported By</p>
		</div>
	</div>
	<div class="nyqyWrap" style="margin-bottom:0px;">
		<ul class="chqyBox clearfix" style="text-align:center;">					
		<img src="/static/2020chongwu/qiyelist.png" style="width:100%;">
		<!--
        <sql sql="select title,thumbnail from h_special_content where (specialid=29 and typeid=5)  order by sort desc,save_time asc limit 50">
...
<div class="hzmt" id="hzmt" >
	...
	<ul class="mt-ul clearfix">
	    ...
	    <sql sql="select title,thumbnail from h_special_content where (specialid=29 and typeid=6)  order by sort desc,save_time asc limit 50">
			<li>
...
<script src="/static/2020chongwu/bootstrap.min.js"></script>
<script src="/static/2020chongwu/jquery.cookie.min.js"></script>
<script src="/static/2020chongwu/layer.min.js"></script>
<script type="text/javascript">
    ...
    if(device_wid<600)
    {   
        $('#top_banner').html('<img src="/static/2020chongwu/600_300.jpg" alt="" style="width:100%;">');
