...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<title>2020SNEC国际太阳能光伏展</title>
	<meta name="keywords" content="2020SNEC国际太阳能光伏展">
	<meta name="description" content="2020SNEC国际太阳能光伏展">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
	<link href="/static/2020snec/bootstrap.min.css" rel="stylesheet">
	<link href="/static/2020snec/css1.css" rel="stylesheet">
	<link href="/static/2020snec/fitCss1.css" rel="stylesheet">
	<!--[if lt IE 9]>
	<script src="//cdn.bootcss.com/html5shiv/3.7.2/html5shiv.min.js"></script>
	<script src="//cdn.bootcss.com/respond.js/1.4.2/respond.min.js"></script>
	<![endif]-->
	<script src="/static/2020snec/jquery.min.js"></script>
<link rel="stylesheet" href="/static/2020snec/layer.css" id="layui_layer_skinlayercss">
...
<div ><div >
	<img src="/static/2020snec/2020_snec.jpg" alt="" style="width:100%;">
</div></div>
	...
	<div class="row news clearfix" style="min-height:600px;">
				<div class="col-md-5 nw-r nw-l" style="width:100%;">
					<ul class="nw-r-ul">
                        ...
                        <sql sql="select * from h_special_content where (specialid=26 and typeid=2) order by sort desc,save_time desc">
							<li class="nw-li-a">
						...
						<sql sql="select * from h_special_content where (specialid=26 and typeid=3) order by sort desc,save_time desc">
							<li class="nw-li-a">
							<a href="{-$values['url']-}" target="_blank">
								{-:($values['title'])-}
							</a>
...
<script src="/static/2020snec/bootstrap.min.js"></script>
<script src="/static/2020snec/jquery.cookie.min.js"></script>
<script src="/static/2020snec/layer.min.js"></script>
<script type="text/javascript">
    ...
    if(device_wid<600)
    {   
        $('#top_banner').html('<img src="/static/2020snec/2020_sckj_mbg.jpg" alt="" style="width:100%;">');
...
</script><span style="display:none" id="cnzz_stat_icon_1254973742"><a href="http://www.cnzz.com/stat/website.php?web_id=1254973742" target="_blank" title="站长统计">站长统计</a></span><script src="/static/2020snec/stat.php" type="text/javascript"></script><script src="/static/2020snec/core.php" charset="utf-8" type="text/javascript"></script>
