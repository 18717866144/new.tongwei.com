...
<div class="special-one">
    <div class="head">
        <sql sql="select thumbnail from h_special_content where specialid=36 and typeid=1 and a_status=1 order by sort desc limit 1">
        ...
        <div class="w1200">
                ...
                <div class="photo-text mb40">
                    <div class="left">
                        <div class="zttwo-hotnews one">
                            <ul class="swiper-wrapper">
                                <sql sql="select title,thumbnail from h_special_content where specialid=36 and typeid=2 and a_status=1 order by sort desc">
                                <li class="swiper-slide">
                                    <a href="javascript:;">
                                        <div class="pic">
                    ...
                    <div class="right">
                        <div class="tops">
                            <sql sql="select * from h_special_content where specialid=36 and typeid=3 and a_status=1 order by id desc limit 1">
                        ...
                        <ul class="list">
                            <sql sql="select title,description,url from h_special_content where specialid=36 and typeid=3 and a_status=1 order by id desc limit 7">
            ...
            <div class="topage" id="jianjie">
                ...
                <div class="meetbrief mb30">
                    <sql sql="select * from h_special_content where specialid=36 and typeid=5 and a_status=1 order by id desc limit 1">
                        {-$values['content']-}
                    </sql>
                </div>
                <table class="meet-table mb40">
            ...
            <div class="topage" id="jiabin">
                ...
                <ul class="guestlist">
                    <sql sql="select title,description,thumbnail from h_special_content where (specialid=36 and typeid=6)  order by sort desc,save_time asc limit 100">
                    <li>
                        <div class="ww">
            ...
            <div class="topage" id="danwei">
                ...
                <div class="partner">
                    <div class="item">
                        ...
                        <div class="cons">
                            <ul class="partlist">
                                <sql sql="select title,thumbnail from h_special_content where (specialid=36 and typeid=7)  order by sort desc,save_time asc limit 50">
                                <li>
                                    <div class="ww">
                    ...
                    <div class="item">
                        ...
                        <div class="cons">
                            <ul class="partlist">
                                <sql sql="select title,thumbnail from h_special_content where (specialid=36 and typeid=8)  order by sort desc,save_time asc limit 50">
                                    <li>
                                        <div class="ww">
                                            <div class="logo"><img src="{-$values['thumbnail']-}" alt=""></div>
                                            <p class="name">{-$values['title']-}</p>
                    ...
                    <div class="item">
                        ...
                        <div class="cons">
                            <ul class="partlist">
                                <sql sql="select title,thumbnail from h_special_content where (specialid=36 and typeid=9)  order by sort desc,save_time asc limit 50">
                                    <li>
                                        <div class="ww">
                                            <div class="logo"><img src="{-$values['thumbnail']-}" alt=""></div>
                                            <p class="name">{-$values['title']-}</p>
            ...
            <div class="topage" id="meiti">
                <div class="partner nobr mb40">
                    <div class="item">
                        ...
                        <div class="cons">
                            <ul class="partlist">
                                <sql sql="select title,thumbnail from h_special_content where (specialid=36 and typeid=10)  order by sort desc,save_time asc limit 50">
                                <li>
                                    <div class="ww">
                                        <div class="logo"><img src="{-$values['thumbnail']-}" alt=""></div>
                                        <p class="name">{-$values['title']-}</p>
