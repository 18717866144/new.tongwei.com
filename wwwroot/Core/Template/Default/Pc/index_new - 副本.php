...
<head>
  ...
  <link rel="stylesheet" href="/Public/twnew/css/index.css?v=3">
</head>
<!--<body  style="background: url(/Public/twnew/images/jiandang100bg.jpg) no-repeat;">-->
<body >
	...
	<div class="nav">
		...
		<div class="nav-main">
	        ...
	        <ul class="layui-nav nav-right" lay-filter="" id="menus">    
				  ...
				  <li class="layui-nav-item " style="position:relative;width:26px;margin-right:15px;">
				  ...
				  <li class="layui-nav-item" style="position:relative;">
				    <a href="javascript:;" class="nav-search" style="margin-right:0px;"></a>
...
<div style="position: relative; padding-bottom:25px;top: -1px;background:#fff;"><!--background:-webkit-linear-gradient(top, #be0000, #FD482C);-->
<div id="main">
	<div class="content1">
			...
			<div class="titles">
				  ...
				  <content limit="1" type="list" where="FIND_IN_SET('h',attr)" cid="15" field="id,title,title_short,title_hot,style,save_time,url,thumbnail">
						<php>
						     ...
						     if($styles[2]){
                                 ...
                                 $size1=$size2="font-size:".$sizes[0]."px;";
                                 if($sizes[1])
                                 $size2 = "font-size:".$sizes[1]."px";								 
						...
						<div class="main-tit" style="{-$lineheight-}">
							...
							<div class="main-tit" style="{-$lineheight-}">
								 ...
								 <span style="{-$size1-}">{-$titles[0]-}</span>								
                ...
                <ul class="news-group-list">
                    <li class="tit" >
						...
						<a href="/news/index.html" target="_blank">集团要闻</a>
					</li>				
				...
				<content limit="12" type="list" cid="15" field="id,title,title_short,style,save_time,url" where="id not in({$noids_str}) and !FIND_IN_SET('d',attr)" order="save_time desc">	
                	<li class="more-list" <?php if($key==11) echo 'style="margin-bottom:0px;"' ?>>
						...
						<a href="{-$values['url']-}" style="" target="_blank">{-$values['title_short']?$values['title_short']:$values['a_title']-}</a>
					</li>				
				</content>
    ...
    <div class="media">
    	<div class="left">
    		<ul class="news-group-list">
                    <li class="tit" >
						<a href="/media/index.html" target="_blank" class="more">+more</a>
						<a href="/media/index.html" target="_blank">媒体报道</a>
					</li>
    	...
    	<div class="right">
            ...
            <div class="layui-tab layui-tab-brief" lay-filter="medias">
			  <ul class="layui-tab-title">
			    <li class="layui-this">文化刊物</li>
			    <li>视频中心</li>
			    <li>新闻专题</li>
				<li>通威微视</li>
			  </ul>
			  <div class="layui-tab-content">
			    <div class="layui-tab-item layui-show" style="padding-bottom: 7px;">
			        <a href="/paper/index.html" class="tab-more">+more</a>
                    <div class="papers" >
			           	  	<div class="newspaper">
			    ...
			    <div class="layui-tab-item" style="padding-bottom: 5px;">
			        <a href="/video/index.html" class="tab-more">+more</a>
                    <div class="videos">
					 	<div class="video">
								<div class="video-bd">
									<ul class="clearfix">	
			    ...
			    <div class="layui-tab-item" style="padding-bottom:10px">
			        <a href="/special/index.html" class="tab-more">+more</a>
                    <div class="specials">
						...
						<sql sql="select id,title,url,create_time from h_special where l_status=1 and is_show=0 order by id desc limit 0,5">
						  ...
						  <li class="special-list">
						   <a href="{-$values.url-}" target="_blank" title="{-$values.title-}">  <span class="list-tit">{-$values.create_time|date="Y-m",###-}</span>{-$values.title-} </a>
						  </li>
				...
				<div class="layui-tab-item" style="padding-bottom: 5px;">
			        <a href="/wvideo/index.html" class="tab-more">+more</a>
                    <div class="wvideos">
					 	<div class="video">
								<div class="video-bd">
									<ul class="clearfix wvideo">	

									<content limit="10" type="list" cid="35" field="id,title,style,save_time,url,description,thumbnail,video">
									 	<li data-video="{-$values.video-}">
										  <img src="{-$values.thumbnail|thumb=###,246,206,1-}"  alt="{-$values.a_title-}" title="{-$values.a_title-}">
										  <div class="play"></div>
										  <div class="video-title"></div>
										  <div class="video-text">
										  	 	{-$values.a_title-}
...
<!--
  ...
  <div class="main">  
    <a href="http://www.tongwei.com.cn" target="_blank" class="logo" style="margin-left:0px;background:url(/Public/twnew/images/twgf.png) no-repeat center 1px;background-size:81%;">
	 <!--<img src="/Public/twnew/images/twgf.png" />-->
	</a>
	
	<a href="http://www.scyxgf.com" target="_blank" class="logo" style="background:url(/Public/twnew/images/yxgf.png) no-repeat center;background-size:80%;">
	
	</a>
	
	<a href="http://www.tw-solar.com" target="_blank" class="logo" style="background:url(/Public/twnew/images/twsolar.png) no-repeat center;background-size:80%;">
	 
	</a>
	
	<a href="http://www.tw-newenergy.com" target="_blank" class="logo" style="background:url(/Public/twnew/images/twnewenergy.png) no-repeat center;background-size:80%;">
	...
	<a href="https://www.tw-nongmu.com/" target="_blank" class="logo" style="background:url(/Public/twnew/images/nongmu.png) no-repeat center;background-size:80%;">
	
	</a>
      <a href="http://www.tongyuwuye.com" target="_blank" class="logo" style="background:url(/Public/twnew/images/tongyuwuye.png) no-repeat center;background-size:80%;">

	</a>
	
	<a href="http://www.tongweifood.cn" target="_blank" class="logo" style="background:url(/Public/twnew/images/twfood.png) no-repeat center 5px;background-size:76%;">
	 
	</a>
	<a href="http://www.tongweifood.cn/list_17.html" target="_blank" class="logo" style="background:url(/Public/twnew/images/twfish.png) no-repeat center;background-size:80%;">
	 
	</a>
	
	<a href="http://www.care-pet.com" target="_blank" class="logo" style="width:116px;margin-right:22px;background:url(/Public/twnew/images/carepet.png) no-repeat center 2px;background-size:99%;">
	
	</a>
	
	<a href="javascript:;" target="_blank" class="logo" style="background:url(/Public/twnew/images/twmedia.png) no-repeat center 6px;background-size:75%;">	 
	</a>
	
	<a href="javascript:;" target="_blank" class="logo" style="background:url(/Public/twnew/images/twshangguan.png) no-repeat center 0px;margin-right:0px;background-size:75%;">	 
	</a>
...
<dd><a href="/wvideo/index.html" target="_blank">通威微视</a></dd>			
		...
		<!--<dl style="border-right:0px;">
			<dt><a href="javascript:;" target="_blank">通威网站群</a></dt>	
			 ...
			 <dd><a href="http://www.care-pet.com/" target="_blank">好主人宠物食品</a></dd>
