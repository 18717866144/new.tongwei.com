...
<form action="__ACTION__" method="post" id="formData">
    ...
    <tr>
		...
		<tr>
			...
			<td class="td_right">
				<input type="text" class="text normal" size="40" name="web_name" datatype="*1-30" errormsg="网站名称格式不正确！"/>
		...
		<tr>
			...
			<td class="td_right">
				<div class="upload_show_text">
					<input type="text" class="text" size="55" name="web_logo" ondblclick="$.CR.G.showIMG(this.value);" value="" readonly="readonly" />&nbsp;&nbsp;
		...
		<tr>
			...
			<td class="td_right">
				<input type="text" class="text" size="55"  name="web_url" datatype="url" errormsg="网站URL格式不正确！" />
		...
		<tr>
			...
			<td class="td_right">
				<input type="text" class="text normal" name="username" datatype="*1-10" ignore="ignore" errormsg="联系人格式不正确！" />
		...
		<tr>
			...
			<td class="td_right">
				<input type="text" class="text normal" name="qq" datatype="/^[1-9][0-9]{4,10}$/" ignore="ignore" errormsg="联系QQ格式不正确！" />
				<span class="setDesc Validform_checktip"></span>
			</td>
		</tr>
		<tr>
			...
			<td class="td_right">
				<input type="text" value="0" name="sort" class="text short" datatype="/^[\d]{1,8}$/" errormsg="排序格式不正确！"  />
		...
		<tr>
			...
			<td class="td_right">
				首页&nbsp;<input type="radio" value="1" name="link_pos" checked="checked" />
				内页&nbsp;<input type="radio" value="2" name="link_pos" />
			</td>
		</tr>
		<tr>
			<td class="td_left">显示状态</td>
			<td class="td_right">
				正常&nbsp;<input type="radio" value="1" name="l_status" checked="checked" />
				隐藏&nbsp;<input type="radio" value="2" name="l_status" />
			</td>
		</tr>
		<tr>
			<td class="td_left">备注</td>
			<td class="td_right"><textarea class="textCont" cols="63" name="remark" datatype="*1-255" errormsg="255个字符以内！！！"  ignore="ignore"></textarea><span class="Validform_checktip setDesc"></span></td>
		</tr>
		<tr>
			<td class="td_left">&nbsp;&nbsp;</td>
			<td class="td_right">
