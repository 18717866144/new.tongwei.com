...
<form action="__ACTION__" method="post" id="formData">
	<table class="formTable">
		<tr>
			...
			<td class="td_right" style="width:auto;">
				...
				<input type="text" name="title" value="" id="title" class="title" datatype="*1-60" errormsg="1-60个字符之间！" size="50" />
				<input id="style_color" type="hidden" value="" name="style_color" />
				<input id="style_font_weight" type="hidden" value="" name="style_font_weight" />
		...
		<tr>
			...
			<td class="td_right">
            <?php echo FormElements::date('start_time',$_GET['start_time'],0,1)?> 到 <?php echo FormElements::date('end_time',$_GET['end_time'],0,0)?>
			</td>
		</tr>
		<tr>
	...
	<tr>
		...
		<td class="td_right">
			<input size="50" class="text" type="text" name="link" errormsg="链接格式不正确！" ignore="ignore" datatype="url" />
	...
	<tr>
		...
		<td class="td_right">
			<label><input type="radio" value="1" name="ann_type" checked="checked" />&nbsp;所有人可见</label>
			<label><input type="radio" value="2" name="ann_type" />&nbsp;仅会员可见</label>
		</td>
	</tr>
	<tr>
		<td class="td_left" >公告状态</td>
		<td class="td_right">
			<label><input type="radio" value="1" name="a_status"  checked="checked" />&nbsp;正常</label>
			<label><input type="radio" value="2" name="a_status" />&nbsp;禁用</label>
		</td>
	</tr>
	<tr>
		<td class="td_left">&nbsp;&nbsp;</td>
