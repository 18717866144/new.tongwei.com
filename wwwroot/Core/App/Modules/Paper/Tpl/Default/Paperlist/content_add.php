...
<input type="hidden" value="<?php echo $pid?>" name="info[pid]" />

<input type="hidden" value="<?php echo $lid?>" name="lid" />
<input type="hidden" value="<?php echo $lid?>" name="info[lid]" />

<input type="hidden" value="<?php echo $layoutid?>" name="layoutid" />
<input type="hidden" value="<?php echo $layoutid?>" name="info[layoutid]" />
