...
<table class="showTable">
	<tr>
		...
		<tr>			
			...
			<td>
				<a href="{-$values.url-}" target="_blank" class="sub">查看</a> &nbsp; <a href="javascript:;" data-id="{-$values.id-}" data-url="{-$values.url-}"  data-title="{-$values.title|str_replace='"','',###|str_replace="'",'',###-}" class="sub selectContent">选择</a>
			</td>
		</tr>
		<?php }?>
		<tr>
