...
<table class="u_m" cellspacing="1">
	<tr>
		<th class="left" width="40%">选择导航范围</th>
		<th>选择操作内容</th>
	</tr>
	<tr>
		<td class="td_left">
		...
		<td style="padding-left:0px;">
			<table class="u_s">
				<tr><td valign="middle">&nbsp;&nbsp;缩略图字段&nbsp;<input type="text" size="12" name="field" value="thumbnail" /></td></tr>
...
function update(){
	...
	window.location.href = '__ACTION__?start=1&cid='+_cid+'&limit='+_limit+'&field='+$('[name="field"]').val();
}
</script>
