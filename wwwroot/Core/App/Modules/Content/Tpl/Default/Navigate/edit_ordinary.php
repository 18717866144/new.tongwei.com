	...
	<div class="main_3 globalMain ">
		<table class="formTable">
            ...
            <tr>
				...
				<td class="td_right">                 
				<textarea name="content" id="content">{-$current['content']-}</textarea>                 
	...
	<div class="main_4 globalMain none">
		<table class="formTable">
			...
			<tr>
				<td class="td_left">链接地址</td>
				<td class="td_right">
					<div class="content_html" <?php echo $setting['content_is_html']==2 ? 'style="display: none;"' : '';?>>{-$contentUrlData_html-}</div>
					<div class="content_no_html" <?php echo $setting['content_is_html']==1 ? 'style="display: none;"' : '';?>>{-$contentUrlData_nohtml-}</div>
				</td>
			</tr>
		</table>
	</div>
