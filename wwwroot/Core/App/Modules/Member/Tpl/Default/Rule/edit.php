...
<input type="hidden" class="" name="token" value="<?php echo $token;?>" />
	<table class="formTable">
		...
		<tr>
			...
			<td class="td_right">
				<input type="text" name="sort" size="20" value="<?php echo $current['sort']?>" class="text short" datatype="/^[\d]{0,8}$/i" errormsg="排序格式不正确！" />
		...
		<tr>
			<td class="td_left"> <span class="Validform_label">附加规则：</span></td>
			<td class="td_right">
				<input type="text" name="append" size="50" value="<?php echo $current['append']?>" class="text" datatype="*1-100" ignore="ignore" errormsg="附加规则格式不正确！" />
				<span class="setDesc Validform_checktip">100个字符以内</span>
			</td>
		</tr>
		<tr>
