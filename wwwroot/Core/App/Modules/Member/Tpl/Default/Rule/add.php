...
<form action="__ACTION__" method="post" id="formData">
	<table class="formTable">
		...
		<tr>
			...
			<td class="td_right">
				<input type="text" name="sort" size="20" value="0" class="text short" datatype="/^[\d]{0,8}$/i" errormsg="排序格式不正确！" />
		...
		<tr>
			...
			<td class="td_right">
				<input type="text" name="append" size="50" value="" class="text" datatype="*1-100" ignore="ignore" errormsg="附加规则格式不正确！" />
				<span class="setDesc Validform_checktip">100个字符以内</span>
			</td>
		</tr>
		<tr>
