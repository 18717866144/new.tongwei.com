...
<div class="operateTitle">编辑行为</div>
...
<input type="hidden" value="<?php echo $current['id']?>" name="id" />
	<table class="formTable">
		<tr>
			...
			<td class="td_right">
				<input type="text" class="text normal" size="35" name="name" datatype="/^[\w]{1,30}$/i" value="<?php echo $current['name']?>" errormsg="用户名格式不正确！" />
		...
		<tr>
			...
			<td class="td_right">
				<input type="text" class="text normal" size="35" name="title" datatype="*1-80" value="<?php echo $current['title']?>" errormsg="1-80个字符之间！" />
		...
		<tr>
			...
			<td class="td_right">
				<select name="type" id="">
					<option value="1" <?php echo $current['type']==1 ? 'selected="selected"' : '';?>>系统</option>
					<option value="2" <?php echo $current['type']==2 ? 'selected="selected"' : '';?>>用户</option>
				</select>
			</td>
		</tr>
		<tr>
			...
			<td class="td_right">
				<textarea class="textCont" cols="50" name="remark" datatype="*1-150" errormsg="行为描述格式不正确！"  ignore="ignore"><?php echo $current['remark']?></textarea>
		...
		<tr>
			...
			<td class="td_right">
				<textarea class="textCont" cols="50" name="rule" datatype="*" errormsg="行为描述格式不正确！"  ignore="ignore"><?php echo $current['rule']?></textarea>
				<span class="setDesc Validform_checktip"></span>
			</td>
		</tr>
		<tr>
