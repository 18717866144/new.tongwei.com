...
<input type="hidden" value="<?php echo $current['id']?>" name="id" />
	<table class="formTable">
		<tr>
			...
			<td class="td_right">
				<input type="text" class="text normal" size="35" value="<?php echo $current['name']?>" name="name" datatype="/^[\w]{1,30}$/i" errormsg="行为名格式不正确！" />
		...
		<tr>
			...
			<td class="td_right">
				<div>
					<textarea name="fields" cols="35" id="fields" rows="10" datatype="*"  errormsg="用户模型字段不能为空！"><?php echo $current['fields']?></textarea>
		...
		<tr>
			...
			<td class="td_right">
				<label>正常&nbsp;<input type="radio" value="1" name="m_status" <?php echo $current['m_status']==1 ? 'checked="checked"' : '';?> /></label>
				<label>禁用&nbsp;<input type="radio" value="2" name="m_status" <?php echo $current['m_status']==2 ? 'checked="checked"' : '';?> /></label>
			</td>
		</tr>
		<tr>
			<td class="td_left">&nbsp;&nbsp;</td>
