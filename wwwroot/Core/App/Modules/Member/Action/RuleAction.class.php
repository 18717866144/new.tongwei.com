...
class RuleAction extends GlobalAction {
	...
	public function index() {
		...
		foreach ($nodeData as &$values) {
			$values['str_manage'] = '<a href="__URL__/add/id/'.$values['id'].'" class="operate">添加子菜单</a>&nbsp;&nbsp;<a class="operate" href="__URL__/edit/id/'.$values['id'].'">编辑</a>&nbsp;&nbsp;<a class="operate" onclick="(_confirm(\'是否确定要删除？\',function(){location.href=\'__URL__/delete/id/'.$values['id'].'\'}))" href="javascript:;">删除</a>';
