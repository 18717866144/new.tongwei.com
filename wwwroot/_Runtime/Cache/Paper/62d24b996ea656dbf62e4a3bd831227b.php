        ...
        <div class="menuswiper">
            ...
            <div class="pt20">
                <div class="fw2">
                    ...
                    <ul class="zaiti-list">
                        <?php $m=0; ?>
                        <?php if(is_array($paper)): $i = 0; $__LIST__ = $paper;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i; $thumbnail = $r['thumbnail']; ?>
                        <li aos="fade-up">
                            <a href="<?php echo ($r['url']); ?>">
                                <div class="pic"><img src="<?php echo ($thumbnail); ?>" alt=""></div>
                                <p class="tt"><?php echo ($r["title"]); ?></p>
                            </a>
                        </li>
                            <?php $m++; endforeach; endif; else: echo "" ;endif; ?>
