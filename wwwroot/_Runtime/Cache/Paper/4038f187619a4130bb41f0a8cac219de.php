...
<header class="header">
    ...
    <div class="mainbox pb50">
        <div class="pt30">
            <div class="fw2 zaiti-flex">
                ...
                <div class="leftmenu">
                    <?php ?>
                    <?php if(is_array($papers)): $i = 0; $__LIST__ = $papers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><a <?php if($r['id'] == $pid): ?>class="active"<?php endif; ?> href="<?php echo ($r['url']); ?>"><?php echo ($r["title"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
                <!-- 小屏上分类展示  -->
 ...
 $t=array(); if($maxtime && $mintime){ for($i=date('Y',$maxtime);$i>=date('Y',$mintime);$i--){ $t[] = $i; } } ?>
                            ...
                            <ul class="swiper-wrapper">
                                <?php if(is_array($t)): $i = 0; $__LIST__ = $t;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><li class="swiper-slide <?php if($r == $year): ?>active<?php endif; ?>"><a class="year-list <?php if($r == $year): ?>active<?php endif; ?>" href="?year=<?php echo ($r); ?>"><?php echo ($r); ?>年</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                        </div>
                    </div>
                    <ul class="zaiti-list w3">
                        <?php if(is_array($paperList)): $i = 0; $__LIST__ = $paperList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$values): $mod = ($i % 2 );++$i;?><li aos="fade-up">
                            <a href="<?php echo ($values['url']); ?>">
                                <div class="pic"><img src="<?php echo ($values["thumbnail"]); ?>" alt=""></div>
                                <p class="tt"><?php echo ($paper["title"]); ?> &nbsp;<?php echo ($values["title"]); ?></p>
                            </a>
                        </li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
