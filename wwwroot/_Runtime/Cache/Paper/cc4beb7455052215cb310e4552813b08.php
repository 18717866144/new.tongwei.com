<?php if (!defined('THINK_PATH')) exit();?>﻿<?php defined('HX_CMS') or exit;$thispid = $navigate['id'];?>
    <?php $navigate = $NAV['22'];$thispid==$NAV['22']['pid']; ?>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="__PUBLIC__/assets/css/public.css?v=2" />
        <link rel="stylesheet" href="__PUBLIC__/assets/css/index.css?v=2" />
        <link rel="stylesheet" href="__PUBLIC__/assets/css/media.css?v=2" />
        <link rel="stylesheet" href="__PUBLIC__/assets/css/indexMedia.css?v=2" />
        <!--[if lt IE 9]>
    ...
    <div class="mainbox pb50">
        <div class="pt30">
            <div class="fw2 zaiti-flex">
                ...
                <div class="leftmenu">
                    <?php ?>
                    <?php if(is_array($papers)): $i = 0; $__LIST__ = $papers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><a href="<?php echo ($r['url']); ?>" target="_blank" <?php if($r['id'] == $pid): ?>class="active"<?php endif; ?> ><?php echo ($r["title"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
                <!-- 小屏上分类展示  -->
                <div class="zaiti-mennu-swiper">
                    <ul class="swiper-wrapper">
                        <?php if(is_array($papers)): $i = 0; $__LIST__ = $papers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i; $rid=$r['id']; ?>
                            <li class="swiper-slide <?php if($rid == $pid): ?>active<?php endif; ?>">
                ...
                <div class="zaiti-right ml">
                    <div class="zaiti-title">
                        ...
                        <p class="title"><?php echo ($paper["title"]); ?>> <?php echo ($paperList["title"]); ?>> <?php echo ($layout["layout_number"]); ?>：<?php echo ($layout["layout_title"]); ?></p>
                        <div class="date-wrap">
                            <a class="datebtn" href="javascript:;"><span>分期查看</span> <img src="__PUBLIC__/assets/images/date.png" alt=""></a>
                            <div class="date-showbox">
                                <div class="inyears">
                                    <?php
 $t=array(); if($maxtime && $mintime){ for($i=date('Y',$maxtime);$i>=date('Y',$mintime);$i--){ $t[] = $i; } } ?>
                                    <ul class="swiper-wrapper">
                                        <?php if(is_array($t)): $i = 0; $__LIST__ = $t;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><li class="swiper-slide yearcl <?php if($r == $year): ?>active<?php endif; ?>" data-year="<?php echo ($r); ?>"><?php echo ($r); ?>年</li><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </ul>
                                </div>
                                <div class="yearcon" id="paperListContent-c">
                                    <?php if(is_array($layoutlist)): $i = 0; $__LIST__ = $layoutlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo ($vo["url"]); ?>"><?php echo ($vo["title"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="zaiti-detail">
                        <div class="left">
                            <?php $zoom = 0.7; $content = json_decode($layout['content'],true); ?>
                            <img src="<?php echo ($layout["thumbnail"]); ?>" alt="<?php echo ($paper["title"]); echo ($paperList["title"]); ?>"  style="position: relative; z-index: 9" usemap="#paperPic">
                        </div>
                        <div class="right">
                            <p class="title">要闻版</p>
                            <ul class="sjlist mb50">
                                <?php if(is_array($content)): $i = 0; $__LIST__ = $content;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; $mapInfo =explode(',', $vo['areaMapInfo']); $width = $mapInfo[2] - $mapInfo[0]; $height = $mapInfo[3] - $mapInfo[1]; $left = $mapInfo[0]; $top = $mapInfo[1]; $width = $width * $zoom; $height = $height * $zoom; $left = $left * $zoom; $top = $top * $zoom; ?>
                                    <a class="positionBg" rel="<?php echo ($key); ?>" href="<?php echo ($vo["areaLink"]); ?>" title="<?php echo ($vo["areaTitle"]); ?>" style="width:<?php echo ($width); ?>px;height:<?php echo ($height); ?>px;left:<?php echo ($left); ?>px;top:<?php echo ($top); ?>px"></a><?php endforeach; endif; else: echo "" ;endif; ?>
                                <?php if(is_array($content)): $i = 0; $__LIST__ = $content;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($vo["areaLink"]); ?>"><?php echo ($vo["areaTitle"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                            <p class="title">本期版面导航</p>
                            <ul class="sjlist mb50">
                                <?php if(is_array($layouts)): $i = 0; $__LIST__ = $layouts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($vo["url"]); ?>"><?php echo ($vo["layout_number"]); ?>：<?php echo ($vo["layout_title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                            <div class="btns">
                                <a href="<?php echo ($prev["url"]); ?>">上一版</a>
                                <a href="<?php echo ($next["url"]); ?>">下一版</a>
                            </div>
                            <style>
