...
<div class="menuwrap">
    ...
    <div class="fw2">
        ...
        <div class="pt30">
            <div class="fw2">
                <!--<p class="intitle" aos="fade-up"><?php echo ($navigate['navigate_name']); ?></p>-->
                <ul class="video-list">
                    		<?php
 import('ORG.TagLib.Contents'); $contentClass = new Contents(); $contentClass->tags = array ( 'type' => 'page', 'cid' => ''.($cid).'', 'cache' => false, 'limit' => '6', 'field' => 'id,cid,title,save_time,style,click,url,description,thumbnail,video', 'start' => '1', 'return' => 'data|values', 'order' => 'sort DESC,save_time DESC', 'tag' => 'foreach', 'tbdt' => true, 'tbpx' => 'small_', ); $data = $contentClass->_page(); $i=1; if(is_array($data['page'])): foreach($data['page'] as $key=>$values): ?><li aos="fade-up">
                        <a href="javascript:;" data-src="<?php echo ($values["video"]); ?>">
