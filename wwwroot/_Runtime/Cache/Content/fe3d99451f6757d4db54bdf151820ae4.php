...
<head>
    ...
    <link rel="stylesheet" href="__PUBLIC__/assets/css/public.css?v=1" />
    <link rel="stylesheet" href="__PUBLIC__/assets/css/index.css?v=1" />
    <link rel="stylesheet" href="__PUBLIC__/assets/css/media.css?v=1" />
    <link rel="stylesheet" href="__PUBLIC__/assets/css/indexMedia.css?v=1" />
    <!--[if lt IE 9]>
...
<div class="mainbox graybg">
                            ...
                            <li class="swiper-slide">
                                <a href="<?php echo ($values["url"]); ?>">
                                    <div class="pic">
                                        ...
                                        <img class="img" src="<?php echo thumb($pic_ulr,384,217,true);?>" alt="<?php echo ($values["title"]); ?>">
                                    </div>
                                    <div class="text">
                                        <?php if($titles[1]) { ?>
 ...
 import('ORG.TagLib.Resolve'); $contentClass = new Resolve(); $contentClass->tags = array ( 'sql' => 'select id,title,url,create_time from h_special where l_status=1 and is_show=0 order by id desc limit 0,10', 'type' => 'list', 'return' => 'data|values', 'tag' => 'foreach', 'cache' => false, ); $data = $contentClass->_sql(); $i=1; if(is_array($data)): foreach($data as $key=>$values): ?><li>
                                    <a href="<?php echo ($values["url"]); ?>" target="_blank">
                                        ...
                                        <p class="date"><?php echo (date("Y-m-d",$values["create_time"])); ?></p>
                                    </a>
                                </li><?php $i++; endforeach; endif; ;?>
                        </ul>
                    </div>
