    ...
    <div class="mainbox pb100">
        <div class="fw2">
            <div class="newsdetail pt50">
                <h3 class="title"><?php echo ($currentData['title_content']?$currentData['title_content']:$currentData['title']); ?></h3>
                <?php if(!empty($currentData["title_bottom"])): ?><p class="subtitle"><?php echo ($currentData['title_bottom']); ?></p><?php endif; ?>
                <div class="tags">
                    <span><?php echo date('Y年m月d日',$currentData['save_time']);?></span>
                    <span><?php if(!empty($currentData['source'])): ?>来源：<?php if(!empty($currentData['sourceurl'])): ?><a href="<?php echo ($currentData['sourceurl']); ?>" target="_blank"><?php echo ($currentData['source']); ?></a><?php else: echo ($currentData['source']); endif; endif; ?></span>
                    <span><?php if(!empty($currentData['author'])): ?>作者：<?php echo ($currentData['author']); endif; ?></span>
                </div>
                <div class="details">
                    <?php echo ($currentData["content"]); ?>
                </div>
                <div class="switch">
                    <a class="prev" href="<?php echo ($next['url']); ?>"><?php echo ($next['title']); ?></a>
                    <a class="next" href="<?php echo ($prev['url']); ?>"><?php echo ($prev['title']); ?></a>
                </div>
            </div>
        </div>
    </div>
