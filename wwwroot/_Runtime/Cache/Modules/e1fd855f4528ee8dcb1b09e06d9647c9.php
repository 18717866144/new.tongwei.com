<?php if (!defined('THINK_PATH')) exit();?>﻿<?php defined('HX_CMS') or exit;$thispid = $navigate['id'];?>
    <?php $navigate = $NAV['17'];$thispid==$NAV['17']['pid']; ?>
        ...
        <div class="aboutbox pt30">
            <div class="fw2">
                ...
                <ul class="special-list">
                    		<?php
 import('ORG.TagLib.Resolve'); $contentClass = new Resolve(); $contentClass->tags = array ( 'type' => 'page', 'table' => 'h_special', 'limit' => '10', 'where' => 'l_status=1 and is_show=0', 'return' => 'data|values', 'tag' => 'foreach', 'cache' => false, ); $data = $contentClass->_sql(); $i=1; if(is_array($data['page'])): foreach($data['page'] as $key=>$values): ?><li aos="fade-up">
                            <a href="<?php echo ($values['url']); ?>" target="_blank">
                                <div class="pic"><img src="<?php echo ($values['thumb']); ?>" alt=""></div>
