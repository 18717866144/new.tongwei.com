                ...
                <ul class="ztone-newslist three">
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$values): $mod = ($i % 2 );++$i;?><li>
                        <a href="<?php echo ($values['url']); ?>">
                            ...
                            <div class="desc"><?php echo msubstr(trim($values['description'],'　'),0,350);?>
                            </div>
