	...
	<table class="formTable">    
		<tr>
			...
			<td class="td_right">
                ...
                <?php if(!empty($type)): if(is_array($type)): foreach($type as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php echo $current['type_id']==$v['id'] ? 'selected="selected"' : '';?>><?php echo ($v["type_name"]); ?></option><?php endforeach; endif; endif; ?>
                </select>
			</td>
		</tr>
        ...
        <tr>
			...
			<td class="td_right"><input type="text" class="text normal" size="50" name="title" value="<?php echo ($current["title"]); ?>"></td>
		</tr>
        <tr>
            <td class="td_left"><span class="Validform_label">副标题</span></td>
            <td class="td_right"><input type="text" class="text" size="50" name="s_title" value="<?php echo ($current["s_title"]); ?>"/></td>
        </tr>
        <tr>
            <td class="td_left">&nbsp;<span class="Validform_label">标题颜色</span></td>
            <td class="td_right">
                <input type="text" class="text" size="10"  name="color" value="<?php echo ($current["color"]); ?>"/>（文字颜色，如：#ffffff）
            </td>
        </tr>
        <tr>
            <td class="td_left"><span class="Validform_label">副标题字体</span></td>
            <td class="td_right"><input type="text" class="text" size="50" name="s_size" value="<?php echo ($current["s_size"]); ?>"/>（字体大小数字，如：16px）</td>
        </tr>
        <tr>
		...
		<tr>
			...
			<td class="td_right">
				<div class="upload_show_text">
					<input type="text" class="text" size="50" name="picurl" value="<?php echo ($current["picurl"]); ?>" />&nbsp;&nbsp;
		...
		<tr>
			...
			<td class="td_right">
				<input type="text" class="text" size="50"  name="url" value="<?php echo ($current["url"]); ?>">				
			</td>
		</tr>
		...
		<tr>
			...
			<td class="td_right">
				<input type="text" class="text" size="10"  name="sort" value="<?php echo ($current["sort"]); ?>" />（大的靠前）				
			</td>
		</tr>
