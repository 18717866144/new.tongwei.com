                ...
                <div class="partner">
                    <div class="item">
                        ...
                        <div class="cons">
                            <ul class="partlist">
                                		<?php
 import('ORG.TagLib.Resolve'); $contentClass = new Resolve(); $contentClass->tags = array ( 'sql' => 'select title,thumbnail from h_special_content where (specialid=39 and typeid=7)  order by sort desc,save_time asc limit 50', 'type' => 'list', 'return' => 'data|values', 'tag' => 'foreach', 'cache' => false, ); $data = $contentClass->_sql(); $i=1; if(is_array($data)): foreach($data as $key=>$values): ?><li>
                                    <div class="ww">
                    ...
                    <div class="item">
                        ...
                        <div class="cons">
                            <ul class="partlist">
                                		<?php
 import('ORG.TagLib.Resolve'); $contentClass = new Resolve(); $contentClass->tags = array ( 'sql' => 'select title,thumbnail from h_special_content where (specialid=39 and typeid=8)  order by sort desc,save_time asc limit 50', 'type' => 'list', 'return' => 'data|values', 'tag' => 'foreach', 'cache' => false, ); $data = $contentClass->_sql(); $i=1; if(is_array($data)): foreach($data as $key=>$values): ?><li>
                                        <div class="ww">
                                            <div class="logo"><img src="<?php echo ($values['thumbnail']); ?>" alt=""></div>
                                            <p class="name"><?php echo ($values['title']); ?></p>
                                        </div>
                    ...
                    <div class="item">
                        ...
                        <div class="cons">
                            <ul class="partlist">
                                		<?php
 import('ORG.TagLib.Resolve'); $contentClass = new Resolve(); $contentClass->tags = array ( 'sql' => 'select title,thumbnail from h_special_content where (specialid=39 and typeid=9)  order by sort desc,save_time asc limit 50', 'type' => 'list', 'return' => 'data|values', 'tag' => 'foreach', 'cache' => false, ); $data = $contentClass->_sql(); $i=1; if(is_array($data)): foreach($data as $key=>$values): ?><li>
                                        <div class="ww">
                                            <div class="logo"><img src="<?php echo ($values['thumbnail']); ?>" alt=""></div>
                                            <p class="name"><?php echo ($values['title']); ?></p>
                                        </div>
                ...
                <div class="partner nobr mb40">
                    <div class="item">
                        ...
                        <div class="cons">
                            <ul class="partlist">
                                		<?php
 import('ORG.TagLib.Resolve'); $contentClass = new Resolve(); $contentClass->tags = array ( 'sql' => 'select title,thumbnail from h_special_content where (specialid=39 and typeid=10)  order by sort desc,save_time asc limit 50', 'type' => 'list', 'return' => 'data|values', 'tag' => 'foreach', 'cache' => false, ); $data = $contentClass->_sql(); $i=1; if(is_array($data)): foreach($data as $key=>$values): ?><li>
                                    <div class="ww">
                                        <div class="logo"><img src="<?php echo ($values['thumbnail']); ?>" alt=""></div>
                                        <p class="name"><?php echo ($values['title']); ?></p>
                                    </div>
