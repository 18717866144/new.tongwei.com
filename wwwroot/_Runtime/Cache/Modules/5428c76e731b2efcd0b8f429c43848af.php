	...
	<table class="formTable">    
		<tr>
            ...
            <select name="type_id">
                ...
                <?php if(!empty($type)): if(is_array($type)): foreach($type as $key=>$values): ?><option value="<?php echo ($values["id"]); ?>"><?php echo ($values["type_name"]); ?></option><?php endforeach; endif; endif; ?>
                </select></td>
		</tr>
        <tr>
