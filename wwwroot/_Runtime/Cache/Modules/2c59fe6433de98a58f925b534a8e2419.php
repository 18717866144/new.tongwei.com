    ...
    <div class="special-three">
        <div class="w1200">
                ...
                <div class="menus">
                    <ul class="swiper-wrapper">
                        ...
                        <li class="swiper-slide first">
                            <a href="<?php echo ($special['url']); ?>"><?php echo ($special['title']); ?></a>
                        </li>
                        <?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="swiper-slide <?php if($v['typeid'] == $typeid): ?>active<?php endif; ?>" data-index="<?php echo ($key+1); ?>}">
                            <a href="<?php echo U('modules/special/lists',array('specialid'=>$specialid,'typeid'=>$v['typeid']));?>"><?php echo ($v['name']); ?></a>
            ...
            <div class="whitebox pd50">
                ...
                <ul class="yulu-list">
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$values): $mod = ($i % 2 );++$i;?><li>
                            <div class="tt">
                                <?php echo (strip_tags($values["content"])); ?>
                            </div>
                            <div class="ts"><?php echo ($values["description"]); ?></div>
                        </li><?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <div class="page-pt">
                    <?php echo ($pages); ?>
